/* Modal Controller */
MetronicApp.controller('catSysGroupSearchController', [
		'$scope',
		'dataTree',
		'caller',
		'modalInstance1',
		...
		$( document ).ready(function() {
			var obj={};
			if($('#treeviewUnits')){
				CommonService.getSysGroupCheckDomain(obj).then(function(result){
			...
			function onChangeTree(dataItem){
				...
				obj.id=dataItem.id
				 ...
				 CommonService.getSysGroupCheckTTKT(obj).then(function(result){
...
// $("#filterText").keyup(function (e) {
			...
			$scope.doSearch= function(){
				...
				CommonService.getSysGroupCheckTTKT($scope.searchGrid).then(function(result){
					var grid =	$scope.gridView;
					grid.dataSource.data(result.plain());
					if(result.plain().length>0){
						grid.dataSource.page(1);
