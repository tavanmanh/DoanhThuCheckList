/* Modal Controller */
MetronicApp.controller('assignHandoverUserNVController', [
    '$scope',
    // 'dataTree',
    'data',
    'caller',
    ...
    function ($scope, data, caller, modalInstance, /*gridOptions,*/ popupId, isMultiSelect,
                ...
                dataSource: {
                    ...
                    transport: {
                        read: {
                            ...
                            url: Constant.BASE_SERVICE_URL + "constructionService/doSearchPerformerNV",
        ...
        function save(dataItem) {
            if (dataItem) {
                var message = '<div style="padding-bottom:100px !important;">Bạn giao việc nhận bàn giao mặt bằng công trình: <br>' +
                    '<font color="red"><b>"' + data.join('", "') + '"</b></font>' +
                    '<br><br>' +
                    'cho nhân viên: ' +
                    '<font color="red"><b>"' + dataItem.fullName + '"</b></font>' +
                    '<br><br>' +
                    'Nhấn <b>"Xác nhận"</b> để thực hiện </div>';
