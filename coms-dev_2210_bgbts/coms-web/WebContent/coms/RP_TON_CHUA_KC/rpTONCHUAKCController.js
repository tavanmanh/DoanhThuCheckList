(function () {
    'use strict';
    var controllerId = 'rpTONCHUAKCController';

    angular.module('MetronicApp').controller(controllerId, rpTONCHUAKCController);

    function rpTONCHUAKCController($scope, $rootScope, $timeout, gettextCatalog,
                                kendoConfig, $kWindow, rpTONCHUAKCService,rpQuantityService,
...
//        }
        $scope.listCheck = [];
        vm.workItemSearch = {};
        vm.String = "Quản lý công trình > Báo cáo >Báo cáo tồn chưa khởi công";
        vm.workItem = {};
                ...
                dataSource: {
                    ...
                    transport: {
                        read: {
                            ...
                            url: Constant.BASE_SERVICE_URL + "rpQuantityService/doSearchKC",
...
vm.getExcelTemplate = function () {
    ...
    vm.exportFileCons = function exportFile() {
		...
		var data = rpQuantityService.doSearchKC(vm.workItemSearch);
		console.log(data);
		rpQuantityService.doSearchKC(vm.workItemSearch).then(function(d){
			CommonService.exportFile(vm.workItemGrid,d.data,vm.listRemove,vm.listConvert,"Báo cáo tồn chưa khởi công");
		});
	}
    vm.listRemove=[{
		title: "Thao tác",
