(function() {
    'use strict';
    var controllerId = 'rpRevenueController';

    angular.module('MetronicApp').controller(controllerId, rpRevenueController);

    function rpRevenueController($scope, $rootScope, $timeout, gettextCatalog,
                                       kendoConfig, $kWindow,$filter,rpRevenueService,htmlCommonService,
        ...
        var record=0;
        $scope.listCheck = [];
        vm.String = "Quản lý công trình > Báo cáo > Chi tiết doanh thu";
        vm.constrObj={};
            ...
            dataSource: {
                ...
                transport: {
                    read: {
                        ...
                        url: Constant.BASE_SERVICE_URL + "rpRevenueService/doSearchForRevenue",
...
vm.exportDT= function(){
	function displayLoading(target) {
	      ...
	      setTimeout(function(){
	    	  ...
	    	  return Restangular.all("rpRevenueService/exportContructionDT").post(vm.searchForm).then(function (d) {
	    	        var data = d.plain();
