/* Modal Controller */
MetronicApp.controller('popupSysGroupController', [
		'$scope',
		'dataTree',
		'caller',
		'modalInstance1',
		...
		$( document ).ready(function() {
			var obj={};
			if($('#treeviewUnits')){
				CommonService.getSysGroup(obj).then(function(result){
...
//			 $("#filterText").keyup(function (e) {
			...
			$scope.doSearch= function(){
				...
				CommonService.getSysGroup($scope.searchGrid).then(function(result){
					var grid =	$scope.gridView;
					grid.dataSource.data(result.plain());
					if(result.plain().length>0){
						grid.dataSource.page(1);
