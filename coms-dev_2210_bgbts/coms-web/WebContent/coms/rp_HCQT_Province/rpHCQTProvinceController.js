(function() {
    'use strict';
    var controllerId = 'rpHCQTProvinceController';

    angular.module('MetronicApp').controller(controllerId, rpHCQTProvinceController);

    function rpHCQTProvinceController($scope, $rootScope, $timeout, gettextCatalog,
        ...
        vm.d={};
        vm.String="Quản lý công trình > Báo cáo > Báo cáo HSHC chưa lên doanh thu theo tỉnh";
                ...
                dataSource:{
                    ...
                    schema: {
                        total: function (response) {
                            $("#countRPProvince").text(""+response.total);
                    ...
                    transport: {
                        read: {
                            ...
                            url: Constant.BASE_SERVICE_URL + "woService/doSearchReportHSHCProvince",
                        ...
                        columns: [
                            {
                                ...
                                template: function(data){
                                    return numberWithCommas(data.quantityTotal);
                                }
                            },
                            {
                                title: "Tổng giá trị",
                                ...
                                columns: [
                                    {
                                        ...
                                        template: function(data){
                                            return numberWithCommas(data.quantityAprovedTotal);
                                        },
                                    },
                                    {
                                        title: "Giá trị",
                                        field: 'aprovedValueTotal',
                                        width: '140px',
                                        headerAttributes: {style: "text-align:center;font-weight: bold;"},
                                        attributes: {
                                            style: "text-align:right;"
                                        ...
                                        template: function(data){
                                            return numberWithCommas(data.aprovedValueTotal);
                                        },
                                    }
                                ]
                            },
                                ...
                                columns: [
                                    {
                                        ...
                                        template: function(data){
                                            return numberWithCommas(data.quantityVtnetTotal);
                                        },
                                    },
                                    {
                                        title: "Giá trị",
                                        field: 'vtnetValueTotal',
                                        width: '140px',
                                        headerAttributes: {style: "text-align:center;font-weight: bold;"},
                                        attributes: {
                                            style: "text-align:right;"
                                        ...
                                        template: function(data){
                                            return numberWithCommas(data.vtnetValueTotal);
                                        },
                                    }
                                ]
                            },
                                ...
                                columns: [
                                    {
                                        ...
                                        template: function(data){
                                            return numberWithCommas(data.quantityDnqtTotal);
                                        },
                                    },
                                    {
                                        title: "Giá trị",
                                        field: 'dnqtValueTotal',
                                        width: '140px',
                                        headerAttributes: {style: "text-align:center;font-weight: bold;"},
                                        attributes: {
                                            style: "text-align:right;"
                                        ...
                                        template: function(data){
                                            return numberWithCommas(data.dnqtValueTotal);
                                        },
                                    }
                                ]
                            },
                                ...
                                columns: [
                                    {
                                        ...
                                        template: function(data){
                                            return numberWithCommas(data.quantityMoneyTotal);
                                        },
                                    },
                                    {
                                        title: "Giá trị",
                                        field: 'moneyValueTotal',
                                        width: '140px',
                                        headerAttributes: {style: "text-align:center;font-weight: bold;"},
                                        attributes: {
                                            style: "text-align:right;"
                                        ...
                                        template: function(data){
                                            return numberWithCommas(data.moneyValueTotal);
                                        },
                                    }
                                ]
                            },
                                ...
                                columns: [
                                    {
                                        ...
                                        template: function(data){
                                            return numberWithCommas(data.quantityAprovedPoblem);
                                        },
                                    },
                                    {
                                        title: "Giá trị",
                                        field: 'aprovedValuePoblem',
                                        width: '140px',
                                        headerAttributes: {style: "text-align:center;font-weight: bold;"},
                                        attributes: {
                                            style: "text-align:right;"
                                        ...
                                        template: function(data){
                                            return numberWithCommas(data.aprovedValuePoblem);
                                        },
                                    }
                                ]
                            },
                                ...
                                columns: [
                                    {
                                        ...
                                        template: function(data){
                                            return numberWithCommas(data.quantityVtnetPoblem);
                                        },
                                    },
                                    {
                                        title: "Giá trị",
                                        field: 'vtnetValuePoblem',
                                        width: '140px',
                                        headerAttributes: {style: "text-align:center;font-weight: bold;"},
                                        attributes: {
                                            style: "text-align:right;"
                                        ...
                                        template: function(data){
                                            return numberWithCommas(data.vtnetValuePoblem);
                                        },
                                    }
                                ]
                            },
                                ...
                                columns: [
                                    {
                                        ...
                                        template: function(data){
                                            return numberWithCommas(data.quantityDnqtPoblem);
                                        },
                                    },
                                    {
                                        title: "Giá trị",
                                        field: 'dnqtValuePoblem',
                                        width: '140px',
                                        headerAttributes: {style: "text-align:center;font-weight: bold;"},
                                        attributes: {
                                            style: "text-align:right;"
                                        ...
                                        template: function(data){
                                            return numberWithCommas(data.dnqtValuePoblem);
                                        },
                                    }
                                ]
                            },
                                ...
                                columns: [
                                    {
                                        ...
                                        template: function(data){
                                            return numberWithCommas(data.quantityMoneyPoblem);
                                        },
                                    },
                                    {
                                        title: "Giá trị",
                                        field: 'moneyValuePoblem',
                                        width: '140px',
                                        headerAttributes: {style: "text-align:center;font-weight: bold;"},
                                        attributes: {
                                            style: "text-align:right;"
                                        ...
                                        template: function(data){
                                            return numberWithCommas(data.moneyValuePoblem);
                                        },
                                    }
                                ]
                            },
        ...
        vm.exportexcel= function(){
            function displayLoading(target) {
                ...
                setTimeout(function(){
                    return Restangular.all("woService/exportFileHSHCProvince").post(vm.searchForm).then(function (d) {
                        var data = d.plain();
