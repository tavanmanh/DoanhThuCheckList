/* Modal Controller */
MetronicApp.controller('goodsSearchController', [
				'$scope',
				'dataTree',
				'caller',
				'modalInstance1',
				...
				function($scope, dataTree, caller, modalInstance1,gridOptions, popupId, isMultiSelect,
						...
						$localStorage, $rootScope, rpNhapXuatTonACapService,Constant,gettextCatalog, $timeout) {
					...
					$(document).ready(function () {
						fillTable();
						$timeout(function (){angular.element('#goodsName').focus();}, 500);
					});
						...
						$scope.gridOptions = kendoConfig.getGridOptions({
							...
							dataSource: {
								...
								transport: {
									read: {
										...
										url: Constant.BASE_SERVICE_URL + "synStockDailyIeService/doSearchGoods",
									...
									parameterMap: function (options, type) {
										...
										if (!!$scope.searchGrid)
											obj = {
												goodsName: $scope.searchGrid.code,
											}
							...
							columns: [{
								...
								template:
									...
									'			<i id="#=goodsCode#" ng-click=save(dataItem) class="fa fa-check color-green" aria-hidden="true"></i> ' +
									'		</a>'
									+ '</div>',
								width: "15%",
								field: "stt"
