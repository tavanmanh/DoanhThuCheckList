(function () {
    'use strict';
    var controllerId = 'reportKpi60DaysController';

    angular.module('MetronicApp').controller(controllerId, reportKpi60DaysController);

    function reportKpi60DaysController($scope, $templateCache, $rootScope, $timeout, gettextCatalog, $filter,
                                      kendoConfig, $kWindow, reportKpi60DaysService, htmlCommonService,
                                      CommonService, PopupConst, Restangular, RestEndpoint, Constant, $http) {

        var vm = this;
        // variables
        vm.String = "Quản lý công trình > Báo cáo > Báo cáo KPI quá hạn 60 ngày";
        ...
        function chartReport(){
			Restangular.all("rpBTSService/" + 'getDataChart60days').post(vm.searchForm).then(function (response) {
				var list=response;
    ...
    var chart2 = AmCharts.makeChart("chartReport60", {
    	"type": "serial",
                ...
                dataSource: {
                    ...
                    transport: {
                        read: {
                            ...
                            url: Constant.BASE_SERVICE_URL + "rpBTSService/doSearchChart60days",
...
//                        format: '{0:n3}',
    ...
    vm.exportWorkItemFile = function(){
    	...
    	return Restangular.all("rpBTSService/exportFileDetailKpi60Days").post(vm.searchForm).then(function (d) {
    	    var data = d.plain();
