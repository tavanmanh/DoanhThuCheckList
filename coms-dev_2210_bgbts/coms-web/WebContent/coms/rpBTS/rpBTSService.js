...
angular.module('MetronicApp').factory('rpBTSService', ['$http', '$q', 'RestEndpoint', 'Restangular', '$kWindow', function($http, $q, RestEndpoint, Restangular, $kWindow){
    ...
    function doSearchBTS(obj) {
        return Restangular.all(serviceUrl+"/doSearchBTS").post(obj);
    }
