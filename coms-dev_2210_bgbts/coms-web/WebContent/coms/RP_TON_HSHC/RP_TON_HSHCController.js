(function () {
    'use strict';
    var controllerId = 'RP_TON_HSHCController';

    angular.module('MetronicApp').controller(controllerId, RP_TON_HSHCController);

    function RP_TON_HSHCController($scope, $rootScope, $timeout, gettextCatalog,
                                kendoConfig, $kWindow, RP_TON_HSHCService,rpQuantityService,
...
//        }
        ...
        vm.String = "Quản lý công trình > Báo cáo > Báo cáo tồn HSHC";
        vm.workItem = {};
                ...
                dataSource: {
                    ...
                    transport: {
                        read: {
                            ...
                            url: Constant.BASE_SERVICE_URL + "rpQuantityService/doSearchHSHC",
...
//                	chinhpxn20180719_end
                ...
                columns: [
                    ...
                    },
                    {
                      ...
                      //hoanm1 20190813 start      {
                       //         title: "Ngày đã chuyển HS về CN",
...
//	vm.workItemSearch.stationCode = data.code;
//}
...
vm.getExcelTemplate = function () {
    ...
    vm.exportFileCons = function exportFile() {
		...
		var data = rpQuantityService.doSearchHSHC(vm.workItemSearch);
		console.log(data);
		rpQuantityService.doSearchHSHC(vm.workItemSearch).then(function(d){
			CommonService.exportFile(vm.workItemGrid,d.data,vm.listRemove,vm.listConvert,"Báo cáo tồn HSHC");
		});
	}
    vm.listRemove=[{
		title: "Thao tác",
