...
<html lang="en" data-ng-app="MetronicApp">
    ...
    <head>
        <title translate>Hệ thống quản lý xây lắp công trình             
        </title>
        <meta charset="utf-8" />
      ...
      <!--   <link href="http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700&subset=all" rel="stylesheet" type="text/css" /> -->
       <link href="${pageContext.request.contextPath}/coms/assets/css/coms-style.css " rel="stylesheet" type="text/css" />
        <script src="${pageContext.request.contextPath}/assets/global/plugins/xlsx.full.min.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/assets/global/plugins/google/chart/amcharts.js" type="text/javascript"></script>
		 <!-- Hoangnh add library chart -->
        <script src="${pageContext.request.contextPath}/assets/global/plugins/google/chart/pie.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/assets/global/plugins/google/chart/export.min.js" type="text/javascript"></script>
       <script src="${pageContext.request.contextPath}/assets/global/plugins/google/chart/light.js" type="text/javascript"></script>
       <script src="${pageContext.request.contextPath}/assets/global/plugins/google/chart/serial.js" type="text/javascript"></script>
       <script src="${pageContext.request.contextPath}/assets/global/plugins/google/chart/pdfmake.min.js" type="text/javascript"></script>
       <script src="${pageContext.request.contextPath}/assets/global/plugins/google/chart/FileSaver.min.js" type="text/javascript"></script>
       <script src="${pageContext.request.contextPath}/assets/global/plugins/google/chart/fabric.min.js" type="text/javascript"></script>
       <script src="${pageContext.request.contextPath}/assets/global/plugins/google/chart/vfs_fonts.js" type="text/javascript"></script>
		<!-- End chart -->
        ...
        <link href="style/css/hcqt.css" rel="stylesheet" type="text/css" />
...
<link href="${pageContext.request.contextPath}/assets/global/kendoui/styles/kendo.bootstrap.min.css" rel="stylesheet" type="text/css" />
		...
		<link href="${pageContext.request.contextPath}/assets/global/grantt/grantt-custome.css" rel="stylesheet" type="text/css" />
    ...
    <body ng-controller="AppController" class="page-header-fixed page-sidebar-closed-hide-logo page-on-load page-sidebar-fixed" ng-class="{'page-content-white': settings.layout.pageContentWhite,'page-container-bg-solid': settings.layout.pageBodySolid, 'page-sidebar-closed': settings.layout.pageSidebarClosed}">
        ...
        <div class="page-container">
            ...
            <div data-ng-include="'${pageContext.request.contextPath}/tpl/sidebarvps.html'" data-ng-controller="SidebarController" class="page-sidebar-wrapper"> </div>
            <!-- END SIDEBAR -->
            <!-- BEGIN CONTENT -->
	...
	<![endif]-->
        ...
        <script src="${pageContext.request.contextPath}/js/lodash.4.17.5.js" type="text/javascript"></script>
	    ...
	    <link href="${pageContext.request.contextPath}/js/jstree/themes/default/style.min.css" rel="stylesheet" type="text/css" />
        <script src="${pageContext.request.contextPath}/js/protypeScript.js?t=20170630" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/js/mainvps.js?t=20170630" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/js/angular-messages.min.js" type="text/javascript"></script>
        ...
        <script src="${pageContext.request.contextPath}/js/mask-input.js" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/js/check-list-directive.js" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/js/gridDetail.directive.js" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/js/app.constants.js?t=20170630" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/js/app.rest.endpoint.js?t=20170630" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/erp/common/mainTab.controller.js?t=20170630" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/erp/common/menuvps.controller.js?t=20170630" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/erp/common/GeneralPageController.js?t=20170630" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/erp/common/CommonService.js?t=20170630" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/erp/common/CommonUtil.js?t=20170630" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/erp/common/SearchService.js?t=20170630" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/erp/common/ModalInstanceController.js?t=20170630" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/erp/common/Tooltip.js?t=20170630" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/erp/common/angular-disable-all.min.js" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/wms/common/PopupCreatNewController.js" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/wms/common/PopupCommonController.js" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/wms/common/AutocompleteSearchBox.js" type="text/javascript"></script>
         <script src="${pageContext.request.contextPath}/wms/common/popupDepartmentController.js" type="text/javascript"></script>
         <script src="${pageContext.request.contextPath}/wms/common/reader_file.js" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/wms/common/Sign_Voffice_Controller.js" type="text/javascript"></script>
		 <script src="${pageContext.request.contextPath}/wms/common/multiSelectStock.js" type="text/javascript"></script>
		  <script src="${pageContext.request.contextPath}/wms/common/dateTime.js" type="text/javascript"></script>
		  
		  <script src="${pageContext.request.contextPath}/js/htmlCommonService.js?t=20170630" type="text/javascript"></script>
 		<script src="${pageContext.request.contextPath}/erp/common/ChartController.js"></script>
	    ...
	    <script src="${pageContext.request.contextPath}/coms/assets/js/isNumber.js"></script>
	    <script src="${pageContext.request.contextPath}/coms/assets/js/initCommonFunction.js"></script>
