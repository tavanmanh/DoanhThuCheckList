...
MetronicApp.directive('parsecurrency3', [function () {
    return {
        restrict: 'A',
        require: 'ngModel',
        scope: {
...
MetronicApp.directive("myRule", function () {
    return {
        restrict: "A",
        require: "ngModel",
...
MetronicApp.directive("odd", function () {
    return {
        restrict: "A",
        require: "ngModel",
        link: function (scope, element, attributes, ngModel) {
...
//picasso them
MetronicApp.directive('onlyNumbers', function () {
    return  {
        restrict: 'A',
