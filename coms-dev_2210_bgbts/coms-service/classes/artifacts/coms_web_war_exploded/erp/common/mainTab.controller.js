...
//	    });
		...
		postal.subscribe({
            ...
            callback : function(data, envelope) {
            	var listFileNeedReload=vm.addVersionToPathList(data.lazyLoadFiles) ;
...
//                        templateUrl: data.templateUrl,
            	...
            	$rootScope.stringtile=data.parent+" > "+data.title;
            }
		...
		function addTab(tabInfo) {
            ...
            var index = getTab(tabInfo.title, tabInfo.templateUrl, tabInfo.data);
