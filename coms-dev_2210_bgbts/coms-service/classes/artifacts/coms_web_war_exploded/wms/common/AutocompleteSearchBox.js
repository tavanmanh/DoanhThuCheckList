...
//					var title = gettextCatalog.getString(label);
					...
					vm.gridOptions = kendoConfig.getGridOptions({
						...
						dataSource: {
							...
							transport: {
					            read: {
					               url: RestEndpoint.BASE_SERVICE_URL + "sysUserCOMSRsService/doSearchUserInPopup",
					               contentType: "application/json; charset=utf-8",
					               type: "POST"
					            },
...
//					      columns: $scope.comboGrid
            ...
            function showGridPopupSuppervisor(vm, sourceLink, label, id, value, name,template, popupId,searchtype) {
//				$scope.comboSearch.name = '';
//				$scope.comboSearch.value = '';
//				$scope.comboSearch.isSize = false;
                tempSelectName = '' ;
...
//					var title = gettextCatalog.getString(label);
                var title = "Danh sách tỉnh trưởng";
                vm.gridOptions = kendoConfig.getGridOptions({
                    autoBind: true,
                    sortable: true,
                    resizable: false,
                    ...
                    dataSource: {
                        ...
                        transport: {
                            read: {
                                url: RestEndpoint.BASE_SERVICE_URL + "sysUserCOMSRsService/doSearchSuppervisorInPopup",
                                contentType: "application/json; charset=utf-8",
                                type: "POST"
                            },
                            ...
                            parameterMap: function(options, type) {
                                ...
                                vm.searchGrid.page = options.page
                                vm.searchGrid.pageSize = options.pageSize
                                //vm.searchGrid.catProvinceCode = 'HNI'
                                vm.searchGrid.constructionCode = vm.constructionCode
                                return  JSON.stringify(vm.searchGrid)
...
//					      columns: $scope.comboGrid
            ...
            function showGridPopupDirector(vm, sourceLink, label, id, value, name,template, popupId,searchtype) {
//				$scope.comboSearch.name = '';
//				$scope.comboSearch.value = '';
//				$scope.comboSearch.isSize = false;
                tempSelectName = '' ;
...
//					var title = gettextCatalog.getString(label);
                var title = "Danh sách phó giám đốc chuyên trách";
                vm.gridOptions = kendoConfig.getGridOptions({
                    autoBind: true,
                    sortable: true,
                    resizable: false,
                    ...
                    dataSource: {
                        ...
                        transport: {
                            read: {
                                url: RestEndpoint.BASE_SERVICE_URL + "sysUserCOMSRsService/doSearchDirectorInPopup",
                                contentType: "application/json; charset=utf-8",
                                type: "POST"
                            },
	        ...
	        setTimeout(function(){
	        	...
	        	if (attrs.comboSourceLink != undefined) {
	        		...
	        		$(element).children('div').children('div').children('i').on('click', function (e) {
                        ...
                        else if(attrs.popupType == 'gridplusSuppervisor'){
                            vm.searchGrid = {};
                            showGridPopupSuppervisor(vm, attrs.popupSourceLink, attrs.modelLabel, attrs.comboValue, attrs.comboCode, attrs.comboName,attrs.templateUrl, attrs.popupId,attrs.searchtype);
                        }
                        else if(attrs.popupType == 'gridplusDirector'){
                            vm.searchGrid = {};
                            showGridPopupDirector(vm, attrs.popupSourceLink, attrs.modelLabel, attrs.comboValue, attrs.comboCode, attrs.comboName,attrs.templateUrl, attrs.popupId,attrs.searchtype);
                        }
                    });
