 ...
 */
function covenantFunction($scope, $rootScope, $timeout, gettextCatalog,$filter,
...
// hợp đồng đầu vào
    ...
    function detaillPXK(dataa){
        ...
        var teamplateUrl = "coms/acceptPXKManage/popupDetailPXK.html";
        var title = "Thông tin phiếu xuất kho";
        var windowId = "POPUP_PHIEU_XK_HL";
                    ...
                    transport: {
                        ...
                        parameterMap: function (options, type) {
                             // vm.appParamSearch.employeeId =
                                ...
                                vm.orderGoodsSearch.typeExport = vm.dataItemPhieuXK.synType
                ...
                dataSource: {
                    ...
                    transport: {
                        ...
                        parameterMap: function (options, type) {
                            ...
                            vm.orderGoodsDetailSearch.typeExport = vm.dataItemPhieuXK.synType;
    ...
    vm.exportPXK = function() {
        var obj = {
        		synStockTransDetailId: vm.orderGoodsDetailSearch.synStockTransDetailId,
        		synStockTransId: vm.synStockTransId
        };
        constructionService.exportFileWordPXK(obj).then(function(data) {
        	if(data.error){
        		toastr.error(data.error);
        		return;
        	}
               ...
               toastr.error(CommonService.translate("loi_khi_export"));
               return;
           }).finally(function() {
    ...
    function fillDataFile(data){
    	vm.fileGridOptions = kendoConfig.getGridOptions({
            autoBind: true,
            resizable: true,
            dataSource: {
                serverPaging: true,
                ...
                transport: {
                    read: {
                        url: Constant.BASE_SERVICE_URL + "synStockTransService/getDataFilePXK",
                        contentType: "application/json; charset=utf-8",
                        type: "POST"
                    },
                    parameterMap: function (options, type) {
                    	...
                    	obj.synStockTransId = vm.dataItemPhieuXK.synStockTransId;
            ...
            dataBound: function () {
                var GridDestination = $("#fileGridId").data("kendoGrid");
            ...
            columns: [
                {
                    title: "TT",
                    field: "stt",
                    template: dataItem => $("#fileGridId").data("kendoGrid").dataSource.indexOf(dataItem) + 1,
                    width: 20,
                    headerAttributes: {
                        style: "text-align:center;"
                    },
