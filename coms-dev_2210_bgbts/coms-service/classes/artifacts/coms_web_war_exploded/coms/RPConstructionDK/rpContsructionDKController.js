(function () {
    ...
    function rpQuantityController($scope, $rootScope, $timeout, gettextCatalog,
                                kendoConfig, $kWindow, rpConstructionDKService,rpQuantityService,
...
//        }
        $scope.listCheck = [];
        vm.workItemSearch = {};
        vm.String = "Quản lý công trình > Báo cáo > Báo cáo đủ điều kiện nhận BGMB";
        vm.workItem = {};
                ...
                dataSource: {
                    ...
                    transport: {
                        read: {
                            ...
                            url: Constant.BASE_SERVICE_URL + "rpQuantityService/doSearch",
                ...
                columns: [
					...
					//hoanm1_20190806_end
                    {
                        ...
                        type :'text',
                            ...
                            {
                                title: "Số ngày đủ điều kiện chưa nhận",
            					field: 'outOfdate',
                                width: '10%',
                                headerAttributes: { style: "text-align:center;font-weight: bold;" },
                                attributes: {
...
vm.getExcelTemplate = function () {
    ...
    vm.exportFileCons = function exportFile() {
		...
		var data = rpQuantityService.doSearch(vm.workItemSearch);
		console.log(data);
		rpQuantityService.doSearch(vm.workItemSearch).then(function(d){
			CommonService.exportFile(vm.workItemGrid,d.data,vm.listRemove,vm.listConvert,"Danh sách đủ điều kiện chưa nhận mặt bằng xây dựng");
		});
	}
    vm.listRemove=[{
		title: "Thao tác",
