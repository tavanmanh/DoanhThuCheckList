...
angular.module('MetronicApp').factory('workItemOSService', ['$http', '$q', 'RestEndpoint', 'Restangular', '$kWindow', function($http, $q, RestEndpoint, Restangular, $kWindow){
    var serviceUrl = 'workItemService';
    var factory = {
    ...
    function saveImage(obj) {
        return Restangular.all(serviceUrl+"/saveImage").post(obj);
    }

    function getAllSourceWork(parType) {
        return Restangular.all(serviceUrl+"/getAllSourceWork").post(parType);
    }
}]);
