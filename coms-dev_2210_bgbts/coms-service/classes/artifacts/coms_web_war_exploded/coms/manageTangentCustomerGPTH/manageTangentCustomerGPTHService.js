...
angular.module('MetronicApp').factory('manageTangentCustomerGPTHService', ['$http', '$q', 'RestEndpoint', 'Restangular', '$kWindow', function($http, $q, RestEndpoint, Restangular, $kWindow){
    var serviceUrl = 'tangentCustomerGPTHRestService';
    var factory = {
        doSearch : doSearch,
        save : save,
        update : update,
