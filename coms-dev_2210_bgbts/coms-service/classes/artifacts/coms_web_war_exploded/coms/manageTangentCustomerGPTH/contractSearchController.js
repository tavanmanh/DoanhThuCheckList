...
//								}else 
								url: Constant.BASE_SERVICE_URL + "tangentCustomerRestService/"+ ($scope.caller.viewForm.isInternalSource == 1 ? "getAllContractXdddSuccessInternal" : "getAllContractXdddSuccess"),
