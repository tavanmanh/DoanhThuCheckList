/* Modal Controller */
MetronicApp.controller('popupDepartmentCnktController', [
		'$scope',
		'dataTree',
		'caller',
		'modalInstance1',
		...
		$( document ).ready(function() {
			var obj={};
			if($('#treeviewUnits')){
				CommonService.getDepartmentCnkt(obj).then(function(result){
...
//			 $("#filterText").keyup(function (e) {
			...
			$scope.doSearch= function(){
				...
				CommonService.getDepartmentCnkt($scope.searchGrid).then(function(result){
					var grid =	$scope.gridView;
					grid.dataSource.data(result.plain());
