(function () {
    'use strict';
    var controllerId = 'congNoTonVTACServiceController';

    angular.module('MetronicApp').controller(controllerId, congNoTonVTACServiceController);

    function congNoTonVTACServiceController($scope, $templateCache, $rootScope, $timeout, gettextCatalog, $filter,
                                      kendoConfig, $kWindow, congNoTonVTACService, htmlCommonService,
                                      CommonService, PopupConst, Restangular, RestEndpoint, Constant, $http) {

        var vm = this;
        // variables
        vm.String = "Quản lý công trình > Báo cáo > Báo cáo công nợ tồn vật tư A cấp cuối kỳ";
        vm.provinceList = [];
        vm.searchForm = {};
...
// translate>Hủy xác nhận</button>' +
                ...
                dataSource: {
                    ...
                    transport: {
                        read: {
                            ...
                            url: Constant.BASE_SERVICE_URL + "rpBTSService/doSearchCongNoTonVTAC",
    ...
    vm.exportWorkItemFile = function(){
    	...
    	return Restangular.all("rpBTSService/exportFileCongNoTonVTAC").post(vm.searchForm).then(function (d) {
    	    var data = d.plain();
