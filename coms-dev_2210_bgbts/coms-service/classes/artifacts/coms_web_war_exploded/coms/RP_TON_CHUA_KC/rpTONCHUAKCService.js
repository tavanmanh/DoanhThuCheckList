...
angular.module('MetronicApp').factory('rpTONCHUAKCService', ['$http', '$q', 'RestEndpoint', 'Restangular', '$kWindow', function($http, $q, RestEndpoint, Restangular, $kWindow){
    var serviceUrl = 'rpTONCHUAKCService';
    var factory = {
