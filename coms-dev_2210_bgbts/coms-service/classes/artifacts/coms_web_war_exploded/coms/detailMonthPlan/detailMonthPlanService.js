...
angular.module('MetronicApp').factory('detailMonthPlanService', ['$http', '$q', 'RestEndpoint', 'Restangular', '$kWindow', function($http, $q, RestEndpoint, Restangular, $kWindow){
    var serviceUrl = 'DetailMonthPlanRsService';
    var factory = {
        remove:remove,
        removeRow: removeRow,
