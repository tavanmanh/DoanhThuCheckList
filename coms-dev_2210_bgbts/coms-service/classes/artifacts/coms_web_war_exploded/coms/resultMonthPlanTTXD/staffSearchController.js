			...
			$scope.gridOptions = kendoConfig.getGridOptions({
				...
				dataSource: {
					...
					transport: {
						read: {
							...
							url: Constant.BASE_SERVICE_URL + "DetailMonthPlanOSRsService/doSearchStaffByPopup",
						...
						parameterMap: function (options, type) {
							...
							if (!!$scope.searchGrid)
								obj = {
									performerName: $scope.searchGrid.code,
								}
				...
				}, 
				{
					...
					template:
						...
						'			<i id="#=performerName#" ng-click=save(dataItem) class="fa fa-check color-green" aria-hidden="true"></i> ' +
						'		</a>'
						+ '</div>',
					width: "15%",
					field: "stt"
