(function () {
    'use strict';
    var controllerId = 'rpNHANBGMBController';

    angular.module('MetronicApp').controller(controllerId, rpNHANBGMBController);

    function rpNHANBGMBController($scope, $rootScope, $timeout, gettextCatalog,
        kendoConfig, $kWindow, rpNHANBGMBService, rpQuantityService,
        ...
        $scope.listCheck = [];
        vm.workItemSearch = {};
        vm.String = "Quản lý công trình > Báo cáo > Báo cáo thông tin nhận mặt bằng";
        vm.workItem = {};
            ...
            vm.workItemGridOptions = kendoConfig.getGridOptions({
                ...
                dataSource: {
                    ...
                    transport: {
                        read: {
                            ...
                            url: Constant.BASE_SERVICE_URL + "rpQuantityService/doSearchNHAN",
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        title: "Mã tỉnh",
                        field: 'catprovincecode',//CAT_PROVINCE_CODE
                        width: '100px',
                        headerAttributes: { style: "text-align:center;font-weight: bold;" },
                        attributes: {
                            style: "text-align:center;"
                    ...
                    },
                    {
                        ...
                        columns: [
                            ...
                            {
                                title: "Loại phòng máy",
                                field: 'houseTypeNameTM',
                                width: '120px',
                                headerAttributes: { style: "text-align:center;font-weight: bold;" },
                                attributes: {
                                    style: "text-align:center;"
                    ...
                    {
                        title: "Loại tiếp điểm",
                        field: 'groundingTypeName',
                        width: '100px',
                        headerAttributes: { style: "text-align:center;font-weight: bold;" },
                        attributes: {
                            style: "text-align:center;"
					...
					{
                        title: "Cột, nhà có sẵn",
                        field: 'houseColumnReady',
                        width: '120px',
                        headerAttributes: { style: "text-align:center;font-weight: bold;" },
                        attributes: {
                            style: "text-align:center;"
					...
					//hoanm1_20190827_start
					{
                        ...
                        columns: [
                            {
                                title: "Đã có điểm đấu",
                                field: 'haveStartPoint',
                                width: '120px',
                                headerAttributes: { style: "text-align:center;font-weight: bold;" },
                                attributes: {
                                    style: "text-align:center;"
					...
					{
                        title: "Nhận MB chưa nhận điểm đấu AC",
                        field: 'stationReceive',
                        width: '220px',
                        headerAttributes: { style: "text-align:center;font-weight: bold;" },
                        attributes: {
                            style: "text-align:center;"
        ...
        vm.exportWorkItemFile = function () {
            function displayLoading(target) {
                ...
                setTimeout(function () {
                    ...
                    return Restangular.all("rpQuantityService/export").post(vm.workItemSearch).then(function (d) {
                        var data = d.plain();
        ...
        vm.doSearchNHAN = doSearchNHAN;
        function doSearchNHAN() {
            vm.showDetail = false;
            var grid = vm.workItemGrid;
            if (grid) {
...
//        }
      ...
      //Huypq-20190315-start
        ...
        vm.exportFileCons = function exportFile() {
            ...
            var data = rpQuantityService.doSearchNHAN(vm.workItemSearch);
            console.log(data);
            rpQuantityService.doSearchNHAN(vm.workItemSearch).then(function (d) {
                CommonService.exportFile(vm.workItemGrid, d.data, vm.listRemove, vm.listConvert, "Báo cáo thông tin nhận mặt bằng");
            });
        }
        vm.listRemove = [{
            title: "Thao tác",
