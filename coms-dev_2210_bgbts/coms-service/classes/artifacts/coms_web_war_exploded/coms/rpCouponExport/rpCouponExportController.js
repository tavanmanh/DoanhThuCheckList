(function () {
    ...
    function rpCouponExportController($scope, $rootScope, $timeout, gettextCatalog,
...
//        }
        ...
        vm.workItemSearch = {};
        vm.listDataObj =[];
        vm.String = "Quản lý công trình > Báo cáo > Phiếu xuất kho A cấp chưa nhận";
...
// '<i id="xuatExcel" class="tooltip1 action-button excelQLK"
// ng-disabled="vm.disableExportExcel" ng-click="vm.exportFileCons()"
...
// class="tooltiptext">Xuất Excel</span></i>' +
                        ...
                        // '<label ng-repeat="column in vm.workItemGrid.columns|
						// filter: vm.gridColumnShowHideFilter">' +
                ...
                dataSource: {
                    ...
                    transport: {
                        read: {
                            ...
                            url: Constant.BASE_SERVICE_URL + "rpQuantityService/doSearchCoupon",
...
vm.getExcelTemplate = function () {
    ...
    vm.exportFileCons = function exportFile() {
		...
		var data = rpQuantityService.doSearchCoupon(vm.workItemSearch);
		console.log(data);
		rpQuantityService.doSearchCoupon(vm.workItemSearch).then(function(d){
			CommonService.exportFile(vm.workItemGrid,d.data,vm.listRemove,vm.listConvert,"Phiếu xuất kho A cấp chưa nhận");
		});
	}
    vm.listRemove=[{
		title: "Thao tác",
