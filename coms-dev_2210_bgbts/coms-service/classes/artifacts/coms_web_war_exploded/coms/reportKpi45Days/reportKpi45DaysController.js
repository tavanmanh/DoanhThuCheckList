(function () {
    'use strict';
    var controllerId = 'reportKpi45DaysController';

    angular.module('MetronicApp').controller(controllerId, reportKpi45DaysController);

    function reportKpi45DaysController($scope, $templateCache, $rootScope, $timeout, gettextCatalog, $filter,
                                      kendoConfig, $kWindow, reportKpi45DaysService, htmlCommonService,
                                      CommonService, PopupConst, Restangular, RestEndpoint, Constant, $http) {

        var vm = this;
        // variables
        vm.String = "Quản lý công trình > Báo cáo > Báo cáo KPI quá hạn 45 ngày";
        ...
        function chartReport(){
			Restangular.all("rpBTSService/" + 'getDataChart').post(vm.searchForm).then(function (response) {
				debugger
				var list=response;
    ...
    var chart2 = AmCharts.makeChart("chartReport45", {
    	"type": "serial",
                ...
                dataSource: {
                    ...
                    transport: {
                        read: {
                            ...
                            url: Constant.BASE_SERVICE_URL + "rpBTSService/doSearchChart",
...
//                        format: '{0:n3}',
    ...
    vm.exportWorkItemFile = function(){
    	...
    	return Restangular.all("rpBTSService/exportFileDetailKpi45Days").post(vm.searchForm).then(function (d) {
    	    var data = d.plain();
