 ...
 * @author HoangNH38
 */
public class TotalMonthPlanOSSimpleDTO extends TotalMonthPlanOSDTO{

    private static final long serialVersionUID = 1L;
    private List<String> signStateList;

    private List<TmpnTargetOSDTO> tmpnTargetDTOList;
    ...
    public List<TmpnTargetOSDTO> getTmpnTargetDTOList() {
        return tmpnTargetDTOList;
    }

    public void setTmpnTargetDTOList(List<TmpnTargetOSDTO> tmpnTargetDTOList) {
