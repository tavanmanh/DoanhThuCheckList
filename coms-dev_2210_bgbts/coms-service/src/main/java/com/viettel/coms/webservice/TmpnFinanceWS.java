...
public interface TmpnFinanceWS {
    ...
    public List<TmpnFinanceDTO> getAll() throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    TmpnFinanceDTO getOneById(Long costCenterId) throws Exception;

    @WebMethod(operationName = "save")
    Long save(TmpnFinanceDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(TmpnFinanceDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<TmpnFinanceDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<TmpnFinanceDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
            throws Exception;
