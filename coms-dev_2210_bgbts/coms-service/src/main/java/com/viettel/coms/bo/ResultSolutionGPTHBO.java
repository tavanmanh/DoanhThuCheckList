...
@Entity
@Table(name = "RESULT_SOLUTION_GPTH")
public class ResultSolutionGPTHBO extends BaseFWModelImpl {

	@Id
	@GeneratedValue(generator = "sequence")
	@GenericGenerator(name = "sequence", strategy = "sequence", parameters = {
			@Parameter(name = "sequence", value = "RESULT_SOLUTION_GPTH_SEQ") })
	@Column(name = "RESULT_SOLUTION_GPTH_ID", length = 10)
	private Long resultSolutionGPTHId;
	...
	@Column(name = "CHECK_SALARY_24H", length = 100)
	private String checkSalary24h;
	@Column(name = "DATE_SALARY_24H", length = 22)
	private Date dateSalary24h;
	...
	public Long getResultSolutionGPTHId() {
		return resultSolutionGPTHId;
	}

	public void setResultSolutionGPTHId(Long resultSolutionGPTHId) {
		this.resultSolutionGPTHId = resultSolutionGPTHId;
	}
	...
	public String getCheckSalary24h() {
		return checkSalary24h;
	}

	public void setCheckSalary24h(String checkSalary24h) {
		this.checkSalary24h = checkSalary24h;
	}

	public Date getDateSalary24h() {
		return dateSalary24h;
	}

	public void setDateSalary24h(Date dateSalary24h) {
		this.dateSalary24h = dateSalary24h;
	}
	...
	@Override
	public ResultSolutionGPTHDTO toDTO() {
		ResultSolutionGPTHDTO dto = new ResultSolutionGPTHDTO();
		dto.setResultSolutionGPTHId(this.getResultSolutionGPTHId());
		...
		dto.setCheckSalary24h(this.getCheckSalary24h());
		dto.setDateSalary24h(this.getDateSalary24h());
		return dto;
	}
