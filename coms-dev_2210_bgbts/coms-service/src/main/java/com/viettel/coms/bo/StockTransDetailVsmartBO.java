 ...
 * @since: 1.0
 */
public class StockTransDetailVsmartBO extends BaseFWModelImpl {
	...
	public StockTransDetailVsmartBO() {
	...
	@Override
	public AIOSynStockTransDetailDTO toDTO() {
		AIOSynStockTransDetailDTO stockTransDetailDTO = new AIOSynStockTransDetailDTO();
		// set cac gia tri
//		stockTransDetailDTO.setSynStockTransDetailId(this.stockTransDetailId);
