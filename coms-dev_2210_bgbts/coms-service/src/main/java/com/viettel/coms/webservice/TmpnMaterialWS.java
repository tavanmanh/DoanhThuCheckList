...
public interface TmpnMaterialWS {
    ...
    public List<TmpnMaterialDTO> getAll() throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    TmpnMaterialDTO getOneById(Long costCenterId) throws Exception;

    @WebMethod(operationName = "save")
    Long save(TmpnMaterialDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(TmpnMaterialDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<TmpnMaterialDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<TmpnMaterialDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
            throws Exception;
