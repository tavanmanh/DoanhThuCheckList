...
public interface YearPlanDetailWS {
    ...
    public List<YearPlanDetailDTO> getAll() throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    YearPlanDetailDTO getOneById(Long costCenterId) throws Exception;

    @WebMethod(operationName = "save")
    Long save(YearPlanDetailDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(YearPlanDetailDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<YearPlanDetailDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<YearPlanDetailDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
            throws Exception;
