...
public interface OrderGoodsDetailWS {
    ...
    public List<OrderGoodsDetailDTO> getAll() throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    OrderGoodsDetailDTO getOneById(Long costCenterId) throws Exception;

    @WebMethod(operationName = "save")
    Long save(OrderGoodsDetailDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(OrderGoodsDetailDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<OrderGoodsDetailDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<OrderGoodsDetailDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
            throws Exception;
