...
public class ResultSolutionGPTHDTO extends ComsBaseFWDTO<ResultSolutionGPTHBO> {
	...
	public String catchName() {
		...
		return resultSolutionGPTHId.toString();
	}
	...
	@Override
	public ResultSolutionGPTHBO toModel() {
		// TODO Auto-generated method stub
		ResultSolutionGPTHBO bo = new ResultSolutionGPTHBO();
		bo.setResultSolutionGPTHId(this.getResultSolutionGPTHId());
		...
		bo.setCheckSalary24h(this.getCheckSalary24h());
		bo.setDateSalary24h(this.getDateSalary24h());
		return bo;
	}
