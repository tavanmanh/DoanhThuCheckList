...
import com.viettel.coms.dto.AIOStockGoodsTotalDTO;
 ...
 * @since: 1.0
 */
public class AIOStockGoodsTotalBO extends BaseFWModelImpl {
	...
	@Override
	public AIOStockGoodsTotalDTO toDTO() {
		AIOStockGoodsTotalDTO stockGoodsTotalDTO = new AIOStockGoodsTotalDTO();
		// set cac gia tri
