...
public interface WorkItemWS {
    ...
    public List<WorkItemDTO> getAll() throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    WorkItemDTO getOneById(Long costCenterId) throws Exception;

    @WebMethod(operationName = "save")
    Long save(WorkItemDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(WorkItemDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<WorkItemDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<WorkItemDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
            throws Exception;
