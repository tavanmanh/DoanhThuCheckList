 ...
 * @author HoangNH38
 */
@Repository("totalMonthPlanOSDAO")
public class TotalMonthPlanOSDAO extends BaseFWDAOImpl<TotalMonthPlanOSBO, Long>{


    public TotalMonthPlanOSDAO() {
        this.model = new TotalMonthPlanOSBO();
    }

    public TotalMonthPlanOSDAO(Session session) {
        this.session = session;
    }

    public List<TotalMonthPlanOSDTO> doSearch(TotalMonthPlanOSSimpleDTO obj) {
        StringBuilder sql = new StringBuilder("SELECT total_month_plan_os_id totalMonthPlanId," + "conclution conclution,"
                ...
                + " FROM TOTAL_MONTH_PLAN_OS WHERE 1=1 ");
        ...
        sql.append(" ORDER BY total_month_plan_os_id DESC");
        ...
        query.setResultTransformer(Transformers.aliasToBean(TotalMonthPlanOSDTO.class));
    ...
    public boolean checkMonthYear(Long month, Long year, Long totalMonthId) {
        ...
        StringBuilder sql = new StringBuilder(
                "SELECT COUNT(TOTAL_MONTH_PLAN_OS_ID) FROM TOTAL_MONTH_PLAN_OS where 1=1 and month=:month and year=:year and status = 1 ");
        if (totalMonthId != null) {
            sql.append(" AND TOTAL_MONTH_PLAN_OS_ID != :totalMonthId ");
        }
        SQLQuery query = getSession().createSQLQuery(sql.toString());
    ...
    public Long getSequence() {
        // TODO Auto-generated method stub
        StringBuilder sql = new StringBuilder("Select TOTAL_MONTH_PLAN_OS_SEQ.nextVal FROM DUAL");
        SQLQuery query = getSession().createSQLQuery(sql.toString());
    ...
    public void remove(Long totalMonthPlanId) {
        // TODO Auto-generated method stub
        StringBuilder sql = new StringBuilder(
                "UPDATE TOTAL_MONTH_PLAN_OS set status = 0  where TOTAL_MONTH_PLAN_OS_ID = :totalMonthPlanId");
        SQLQuery query = getSession().createSQLQuery(sql.toString());
        query.setParameter("totalMonthPlanId", totalMonthPlanId);
        query.executeUpdate();
    }

    public TotalMonthPlanOSSimpleDTO getById(Long id) {
        StringBuilder sql = new StringBuilder("SELECT total_month_plan_os_id totalMonthPlanId," + "  year year,"
                ...
                + " FROM TOTAL_MONTH_PLAN_OS WHERE 1=1 and total_month_plan_os_id =:id");
        SQLQuery query = getSession().createSQLQuery(sql.toString());
        ...
        query.setResultTransformer(Transformers.aliasToBean(TotalMonthPlanOSSimpleDTO.class));
        return (TotalMonthPlanOSSimpleDTO) query.uniqueResult();
    }

    public TmpnTargetOSDTO getTmpnTargetDTOListChoseByParent(Long month, Long year, Long sysGroupId) {
        // TODO Auto-generated method stub
        StringBuilder sql = new StringBuilder(" ");
        sql.append(" SELECT ");
...
//				sql.append("   ) revenueLk, ");
        ...
        sql.append("   FROM YEAR_PLAN_DETAIL_OS yq ");
        sql.append("   LEFT JOIN YEAR_PLAN_OS y ");
        sql.append("   ON y.year_plan_os_id     = yq.year_plan_os_id ");
...
//		sql.append(" and ypd.SYS_GROUP_ID          =:sysGroupId and ypd.month=:month and ypd.year=:year  ");
        ...
        query.setResultTransformer(Transformers.aliasToBean(TmpnTargetOSDTO.class));
        List<TmpnTargetOSDTO> res = query.list();
        TmpnTargetOSDTO data = new TmpnTargetOSDTO();
        if (res != null && !res.isEmpty())
            data = res.get(0);
        return data;
    }

    public List<TmpnTargetOSDTO> getTmpnTargetDTOListByParent(Long id) {
        // TODO Auto-generated method stub
        if (id == null)
            return new ArrayList<TmpnTargetOSDTO>();
        StringBuilder sql = new StringBuilder(" ");
        sql.append("SELECT ypd.Total_month_plan_os_id totalMonthPlanId, ");
        sql.append("  ypd.TMPN_TARGET_OS_ID tmpnTargetId, ");
...
//		sql.append("  )) revenueLk, ");
        ...
        sql.append("  (SELECT SUM(yq.quantity) ");
        sql.append("  FROM YEAR_PLAN_DETAIL_OS yq ");
        sql.append("  INNER JOIN year_plan_os y ");
        sql.append("  ON y.year_plan_os_id     = yq.year_plan_os_id ");
        sql.append("  AND y.status          = 1 ");
        ...
        sql.append("  FROM YEAR_PLAN_DETAIL_OS yq ");
        sql.append("  INNER JOIN year_plan_os y ");
        sql.append("  ON y.year_plan_os_id     = yq.year_plan_os_id  AND y.status          = 1 ");
        sql.append("  WHERE yq.SYS_GROUP_ID = ypd.SYS_GROUP_ID ");
        sql.append("  AND yq.year           = ypd.year ");
        sql.append("  ");
        sql.append("  )) completeInYear, ");
        ...
        sql.append("  AND y.status          = 1 ");
        sql.append("  )) revenueInYear ");
        sql.append("FROM TMPN_TARGET_OS ypd ");
        sql.append("LEFT JOIN CTCT_CAT_OWNER.SYS_GROUP sg ");
        sql.append("ON ypd.SYS_GROUP_ID          =sg.SYS_GROUP_ID ");
        sql.append("WHERE ypd.Total_month_plan_os_id=:id ");
        sql.append("group by ypd.Total_month_plan_os_id, ");
        sql.append("  ypd.TMPN_TARGET_OS_ID, ");
    ...
    public List<TmpnForceNewBtsDTO> getTmpnForceNewBtsDTOListByParent(Long id) {
        ...
        StringBuilder sql = new StringBuilder("SELECT ypd.total_month_plan_os_id totalMonthPlanId,"
    ...
    public List<TmpnForceNewLineDTO> getTmpnForceNewLineDTOListByParent(Long id) {
        ...
        StringBuilder sql = new StringBuilder(
                "SELECT ypd.total_month_plan_os_id totalMonthPlanId," + "ypd.TMPN_FORCE_NEW_LINE_ID tmpnForceNewLineId,"
    ...
    public List<TotalMonthPlanOSSimpleDTO> fillterAllActiveCatConstructionDeploy(TotalMonthPlanOSSimpleDTO obj) {
        if (obj.getCatConstructionTypeId() == null)
            return new ArrayList<TotalMonthPlanOSSimpleDTO>();
        // TODO Auto-generated method stub
    ...
    public List<TotalMonthPlanOSSimpleDTO> getAllConstructionType() {
        // TODO Auto-generated method stub
        StringBuilder sql = new StringBuilder(
    ...
    /*
     * public List<TotalMonthPlanOSSimpleDTO> getAllConstructionDeploy() { // TODO
     ...
     * .aliasToBean(TotalMonthPlanOSSimpleDTO.class)); return query.list(); }
     */

    public TotalMonthPlanOSSimpleDTO getConstructionTypeByCode(String constructionType) {
        TotalMonthPlanOSSimpleDTO rs = new TotalMonthPlanOSSimpleDTO();
        // TODO Auto-generated method stub
        if (StringUtils.isNotEmpty(constructionType)) {
            ...
            query.addScalar("catConstructionTypeName", new StringType());
            query.setResultTransformer(Transformers.aliasToBean(TotalMonthPlanOSSimpleDTO.class));
            List<TotalMonthPlanOSSimpleDTO> ls = query.list();
    ...
    public TotalMonthPlanOSSimpleDTO getConstructionDeployById(String id) {
        TotalMonthPlanOSSimpleDTO rs = new TotalMonthPlanOSSimpleDTO();
        // TODO Auto-generated method stub
    ...
    public YearPlanDetailOSDTO getYearPlanDetail(TotalMonthPlanOSSimpleDTO obj) {
        ...
        StringBuilder sql = new StringBuilder("SELECT   sum(ypd.SOURCE) source,  sum(ypd.QUANTITY) quantity, "
                ...
                + " FROM YEAR_PLAN_DETAIL_OS ypd LEFT JOIN CTCT_CAT_OWNER.SYS_GROUP sg "
                + " ON ypd.SYS_GROUP_ID =sg.SYS_GROUP_ID "
                + " left join year_plan_os yp on yp.YEAR_PLAN_OS_ID = ypd.YEAR_PLAN_OS_ID " + " WHERE ypd.month     =:month "
        ...
        return (YearPlanDetailOSDTO) query.uniqueResult();
    }

    public List<TmpnTargetOSDTO> getTargetForExport(Long totalMonthPlanId) {
        // TODO Auto-generated method stub
        ...
        sql.append("    (SELECT SUM(yq.quantity) ");
        sql.append("    FROM YEAR_PLAN_DETAIL_OS yq INNER JOIN year_plan_os y ");
        sql.append("  ON y.year_plan_os_id     = yq.year_plan_os_id and y.status=1 ");
        sql.append("    WHERE yq.SYS_GROUP_ID = ypd.SYS_GROUP_ID ");
        sql.append("    AND yq.year           = ypd.year ");
        ...
        sql.append("  INNER JOIN TOTAL_MONTH_PLAN_OS tmpn ");
        sql.append("  ON ypd.total_month_plan_os_id   = tmpn.total_month_plan_os_id ");
        ...
        sql.append("    ) quantityInYear, ");
        sql.append("    (SELECT SUM(yq.complete) ");
        sql.append("    FROM YEAR_PLAN_DETAIL_OS yq INNER JOIN year_plan y ");
    ...
    public List<TmpnSourceDTO> getSourceForExport(Long totalMonthPlanId) {
        ...
        sql.append(" WHERE ypd.total_month_plan_os_id=:id group by ypd.total_month_plan_os_id ),child as( ");
        sql.append(
    ...
    public List<TmpnForceMaintainDTO> getForceMaintainForExport(Long totalMonthPlanId) {
        ...
        sql.append(
                " FROM TMPN_FORCE_MAINTAIN ypd WHERE ypd.total_month_plan_os_id=:id), child as(SELECT  ypd.Build_plan buildPlan,  ypd.Install_plan installPlan, ");
        sql.append(
        ...
        sql.append(
                " ON ypd.SYS_GROUP_ID          =sg.SYS_GROUP_ID WHERE ypd.total_month_plan_os_id=:id ORDER BY sg.NAME ASC, ");
        sql.append(
    ...
    public List<TmpnForceNewBtsDTO> getBTSForExport(Long totalMonthPlanId) {
        ...
        sql.append(
                " AVG(ypd.Self_implement_percent)selfImplementPercent, null sysGroupName,null description, 0 stt  FROM TMPN_FORCE_NEW_BTS ypd WHERE ypd.total_month_plan_os_id=:id), ");
        sql.append(
        ...
        sql.append(
                " LEFT JOIN CTCT_CAT_OWNER.SYS_GROUP sg ON ypd.SYS_GROUP_ID          =sg.SYS_GROUP_ID WHERE ypd.total_month_plan_os_id=:id ");
        sql.append(
                " ORDER BY sg.NAME ASC ), record as( select * from parent union all select * from child) select * from record ORDER BY stt ASC,sysGroupName ASC ");
        SQLQuery query = getSession().createSQLQuery(sql.toString());
        query.setParameter("id", totalMonthPlanId);
    ...
    public List<TmpnForceNewLineDTO> getNewLineForExport(Long totalMonthPlanId) {
        ...
        sql.append(
                " null sysGroupName, null description, 0 stt FROM TMPN_FORCE_NEW_LINE ypd WHERE ypd.total_month_plan_os_id=:id ");
        sql.append(
    ...
    public List<TmpnFinanceDTO> getFinanceForExport(Long totalMonthPlanId) {
        // TODO Auto-generated method stub
        StringBuilder sql = new StringBuilder(
                " with parent as(select sum(ypd.First_times)+sum(ypd.Second_times)+ sum(ypd.Three_times) firstTimes , null sysGroupName, null description, 0 stt FROM TMPN_FINANCE ypd WHERE ypd.total_month_plan_os_id=:id), ");
        ...
        sql.append(" LEFT JOIN CTCT_CAT_OWNER.SYS_GROUP sg ON ypd.SYS_GROUP_ID          =sg.SYS_GROUP_ID ");
        sql.append(" WHERE ypd.total_month_plan_os_id=:id group by sg.NAME   ,ypd.Description), ");
        sql.append(
    ...
    public List<TmpnContractDTO> setContractForExport(Long totalMonthPlanId) {
        ...
        sql.append(" FROM TMPN_CONTRACT ypd  WHERE ypd.total_month_plan_os_id=:id  ),  child AS ");
        sql.append(
...
//		sql.append("   ) revenueLk, ");
        ...
        sql.append("   (SELECT SUM(yq.quantity) ");
        sql.append("   FROM YEAR_PLAN_DETAIL_OS yq ");
        sql.append("   INNER JOIN YEAR_PLAN_OS yp ");
        sql.append("   ON yq.YEAR_PLAN_OS_ID    = yp.YEAR_PLAN_OS_ID ");
    ...
    public void updateTargetNote(String targetNote, Long totalMonthPlanId) {
        // TODO Auto-generated method stub
        StringBuilder sql = new StringBuilder(
                " update TOTAL_MONTH_PLAN_OS set TARGET_NOTE =:note where TOTAL_MONTH_PLAN_OS_ID = :totalMonthPlanId");
        SQLQuery query = getSession().createSQLQuery(sql.toString());
    ...
    public void updateSourceNote(String sourceNote, Long totalMonthPlanId) {
        // TODO Auto-generated method stub
        StringBuilder sql = new StringBuilder(
                " update TOTAL_MONTH_PLAN_OS set SOURCE_NOTE =:note where TOTAL_MONTH_PLAN_OS_ID = :totalMonthPlanId");
        SQLQuery query = getSession().createSQLQuery(sql.toString());
    ...
    public void updateContractNote(String contractNote, Long totalMonthPlanId) {
        // TODO Auto-generated method stub
        StringBuilder sql = new StringBuilder(
                " update TOTAL_MONTH_PLAN_OS set CONTRACT_NOTE =:note where TOTAL_MONTH_PLAN_OS_ID = :totalMonthPlanId");
        SQLQuery query = getSession().createSQLQuery(sql.toString());
    ...
    public void updateFinanceNote(String financeNote, Long totalMonthPlanId) {
        // TODO Auto-generated method stub
        StringBuilder sql = new StringBuilder(
                " update TOTAL_MONTH_PLAN_OS set FINANCE_NOTE =:note where TOTAL_MONTH_PLAN_OS_ID = :totalMonthPlanId");
        SQLQuery query = getSession().createSQLQuery(sql.toString());
    ...
    public void updateMaterialNote(String materialNote, Long totalMonthPlanId) {
        // TODO Auto-generated method stub
        StringBuilder sql = new StringBuilder(
                " update TOTAL_MONTH_PLAN_OS set MATERIAL_NOTE =:note where TOTAL_MONTH_PLAN_OS_ID = :totalMonthPlanId");
        SQLQuery query = getSession().createSQLQuery(sql.toString());
    ...
    public void updateBTSNote(String btsNote, Long totalMonthPlanId) {
        // TODO Auto-generated method stub
        StringBuilder sql = new StringBuilder(
                " update TOTAL_MONTH_PLAN_OS set BTS_NOTE =:note where TOTAL_MONTH_PLAN_OS_ID = :totalMonthPlanId");
        SQLQuery query = getSession().createSQLQuery(sql.toString());
    ...
    public void updateLineNote(String lineNote, Long totalMonthPlanId) {
        // TODO Auto-generated method stub
        StringBuilder sql = new StringBuilder(
                " update TOTAL_MONTH_PLAN_OS set LINE_NOTE =:note where TOTAL_MONTH_PLAN_OS_ID = :totalMonthPlanId");
        SQLQuery query = getSession().createSQLQuery(sql.toString());
    ...
    public void updateMaintainNote(String maintainNote, Long totalMonthPlanId) {
        // TODO Auto-generated method stub
        StringBuilder sql = new StringBuilder(
                " update TOTAL_MONTH_PLAN_OS set MAINTAIN_NOTE =:note where TOTAL_MONTH_PLAN_OS_ID = :totalMonthPlanId");
        SQLQuery query = getSession().createSQLQuery(sql.toString());
    ...
    public void updateRegistry(Long totalMonthPlanId) {
        StringBuilder sql = new StringBuilder(
                "UPDATE TOTAL_MONTH_PLAN_OS set SIGN_STATE = '3'  where TOTAL_MONTH_PLAN_OS_ID = :totalMonthPlanId");
        SQLQuery query = getSession().createSQLQuery(sql.toString());
        query.setParameter("totalMonthPlanId", totalMonthPlanId);
        query.executeUpdate();
    }
    
    //Huypq-20200511-start
    public List<TmpnTargetOSDTO> getTmpnTargetDTOListByParentNew(Long id) {
        // TODO Auto-generated method stub
        if (id == null)
            return new ArrayList<TmpnTargetOSDTO>();
        StringBuilder sql = new StringBuilder(" ");
        ...
        sql.append("  ypd.YEAR YEAR, ");
        sql.append("  sg.NAME sysGroupName, ");
        sql.append(" ypd.COMPLETE_TARGET/1000000 completeTarget, " + 
	        		" ypd.HSHC_XL_TARGET/1000000 hshcXlTarget, " + 
	        		" ypd.REVENUE_CP_TARGET/1000000 revenueCpTarget, " + 
	        		" ypd.REVENUE_NTD_GPDN_TARGET/1000000 revenueNtdGpdnTarget, " + 
	        		" ypd.REVENUE_NTD_XDDD_TARGET/1000000 revenueNtdXdddTarget, " + 
	        		" ypd.HSHC_HTCT_TARGET/1000000 hshcHtctTarget, " + 
	        		" ypd.QUANTITY_XL_TARGET/1000000 quantityXlTarget, " + 
	        		" ypd.QUANTITY_CP_TARGET/1000000 quantityCpTarget, " + 
	        		" ypd.QUANTITY_NTD_GPDN_TARGET/1000000 quantityNtdGpdnTarget, " + 
	        		" ypd.QUANTITY_NTD_XDDD_TARGET/1000000 quantityNtdXdddTarget, " + 
	        		" ypd.TASK_XDDD_TARGET/1000000 taskXdddTarget, " + 
	        		" ypd.REVOKE_CASH_TARGET/1000000 revokeCashTarget, " + 
	        		" ypd.SUM_DEPLOY_HTCT sumDeployHtct, " + 
	        		" ypd.BUILD_COMPLETE_HTCT buildCompleteHtct, " + 
	        		" ypd.COMPLETE_DB_HTCT completeDbHtct, " + 
	        		" ypd.RENT_HTCT rentHtct ");
        sql.append("FROM TMPN_TARGET_OS ypd ");
        sql.append("LEFT JOIN CTCT_CAT_OWNER.SYS_GROUP sg ");
        sql.append("ON ypd.SYS_GROUP_ID          =sg.SYS_GROUP_ID ");
        sql.append("WHERE ypd.Total_month_plan_os_id=:id ");
        ...
        query.addScalar("sysGroupId", new LongType());
        query.addScalar("sysGroupName", new StringType());
        query.addScalar("completeTarget", new DoubleType());
        ...
        query.addScalar("sumDeployHtct", new LongType());
        query.addScalar("buildCompleteHtct", new LongType());
        query.addScalar("completeDbHtct", new LongType());
        query.addScalar("rentHtct", new LongType());
        query.setResultTransformer(Transformers.aliasToBean(TmpnTargetOSDTO.class));
        return query.list();
    }
    //Huy-end
