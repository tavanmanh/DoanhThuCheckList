...
@XmlRootElement(name = "TANGENT_CUSTOMERBO")
@JsonIgnoreProperties(ignoreUnknown = true)
public class TangentCustomerDTO extends ComsBaseFWDTO<TangentCustomerBO>{
	...
	public String catchName() {
		...
		return tangentCustomerId.toString();
	}
	...
	@Override
	public TangentCustomerBO toModel() {
		TangentCustomerBO bo = new TangentCustomerBO();
		bo.setTangentCustomerId(this.getTangentCustomerId());
		bo.setCustomerName(this.getCustomerName());
		bo.setBirthYear(this.getBirthYear());
	...
	private ResultTangentDTO resultTangentDTO;
...
//	hoanm1_20200612_end
	public ResultTangentDTO getResultTangentDTO() {
		return resultTangentDTO;
	}

	public void setResultTangentDTO(ResultTangentDTO resultTangentDTO) {
		this.resultTangentDTO = resultTangentDTO;
	}
	...
	private List<ResultTangentDTO> listResultTangent;
	private List<ResultSolutionDTO>  listResultSolution;

	public List<ResultTangentDTO> getListResultTangent() {
		return listResultTangent;
	}

	public void setListResultTangent(List<ResultTangentDTO> listResultTangent) {
		this.listResultTangent = listResultTangent;
	}

	public List<ResultSolutionDTO> getListResultSolution() {
		return listResultSolution;
	}

	public void setListResultSolution(List<ResultSolutionDTO> listResultSolution) {
		this.listResultSolution = listResultSolution;
	}
