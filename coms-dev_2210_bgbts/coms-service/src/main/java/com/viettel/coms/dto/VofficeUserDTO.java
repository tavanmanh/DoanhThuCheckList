...
@XmlType(name = "vof2EntityUser", propOrder = {"adOrgId", "adOrgName", "aliasName", "fullName", "homePhone",
        "isDefault", "isPublicText", "isSecrectaryVo2", "jobTile", "jobTitle", "languageCode", "loginName",
        "mobileNumber", "pathDepart2", "signImageIndex", "specializedOrgId", "staff", "strAddress", "strCANumber",
        "strCardNumber", "strDateOfBirth", "strEmail", "strIdentification", "sysOrgId", "sysOrgName", "sysRoleId",
        "userId", "userLanguage"})
