...
public interface UtilAttachDocumentWS {
    ...
    public List<UtilAttachDocumentDTO> getAll() throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    UtilAttachDocumentDTO getOneById(Long costCenterId) throws Exception;

    @WebMethod(operationName = "save")
    Long save(UtilAttachDocumentDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(UtilAttachDocumentDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<UtilAttachDocumentDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<UtilAttachDocumentDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
            throws Exception;
