...
@Entity
@Table(name = "TANGENT_CUSTOMER_GPTH")
public class TangentCustomerGPTHBO extends BaseFWModelImpl {

	@Id
	@GeneratedValue(generator = "sequence")
	@GenericGenerator(name = "sequence", strategy = "sequence", parameters = {
			@Parameter(name = "sequence", value = "TANGENT_CUSTOMER_GPTH_SEQ") })
	...
	@Column(name = "BCI_CODE", length = 50)
