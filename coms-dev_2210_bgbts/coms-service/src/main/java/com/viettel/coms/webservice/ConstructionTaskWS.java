...
public interface ConstructionTaskWS {
    ...
    public List<ConstructionTaskDTO> getAll() throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    ConstructionTaskDTO getOneById(Long costCenterId) throws Exception;

    @WebMethod(operationName = "save")
    Long save(ConstructionTaskDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(ConstructionTaskDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<ConstructionTaskDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<ConstructionTaskDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
            throws Exception;
