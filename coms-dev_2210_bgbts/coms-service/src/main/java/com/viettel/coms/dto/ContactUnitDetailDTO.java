...
@XmlRootElement(name = "CONTACT_UNIT_DETAILBO")
@JsonIgnoreProperties(ignoreUnknown = true)
public class ContactUnitDetailDTO extends ComsBaseFWDTO<ContactUnitDetailBO>{
	...
	@Override
	public ContactUnitDetailBO toModel() {
		ContactUnitDetailBO bo = new ContactUnitDetailBO();
		...
		bo.setDescription(this.description); //HienLT56 add 16072020
		return bo;
	}
	
	//HienLT56 start 03072020
