...
public interface DetailMonthPlanWS {
    ...
    public List<DetailMonthPlanDTO> getAll() throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    DetailMonthPlanDTO getOneById(Long costCenterId) throws Exception;

    @WebMethod(operationName = "save")
    Long save(DetailMonthPlanDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(DetailMonthPlanDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<DetailMonthPlanDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<DetailMonthPlanDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
            throws Exception;
