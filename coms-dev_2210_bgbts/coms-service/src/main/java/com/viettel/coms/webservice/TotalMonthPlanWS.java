...
public interface TotalMonthPlanWS {
    ...
    public List<TotalMonthPlanDTO> getAll() throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    TotalMonthPlanDTO getOneById(Long costCenterId) throws Exception;

    @WebMethod(operationName = "save")
    Long save(TotalMonthPlanDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(TotalMonthPlanDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<TotalMonthPlanDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<TotalMonthPlanDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
            throws Exception;
