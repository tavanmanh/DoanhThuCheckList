...
public interface ConfigGroupProvinceWS {
    ...
    public List<ConfigGroupProvinceDTO> getAll() throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    ConfigGroupProvinceDTO getOneById(Long costCenterId) throws Exception;

    @WebMethod(operationName = "save")
    Long save(ConfigGroupProvinceDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(ConfigGroupProvinceDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<ConfigGroupProvinceDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<ConfigGroupProvinceDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
            throws Exception;
