...
public interface TmpnContractWS {
    ...
    public List<TmpnContractDTO> getAll() throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    TmpnContractDTO getOneById(Long costCenterId) throws Exception;

    @WebMethod(operationName = "save")
    Long save(TmpnContractDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(TmpnContractDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<TmpnContractDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<TmpnContractDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
            throws Exception;
