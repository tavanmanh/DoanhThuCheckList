...
public interface TmpnSourceWS {
    ...
    public List<TmpnSourceDTO> getAll() throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    TmpnSourceDTO getOneById(Long costCenterId) throws Exception;

    @WebMethod(operationName = "save")
    Long save(TmpnSourceDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(TmpnSourceDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<TmpnSourceDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<TmpnSourceDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
            throws Exception;
