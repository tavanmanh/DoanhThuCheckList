...
public class CatStationDTO extends ComsBaseFWDTO<CatStationBO> {
    ...
    public CatStationBO toModel() {
        ...
        catStationBO.setCompleteStatus(this.completeStatus);
        catStationBO.setRentStatus(this.rentStatus);
        return catStationBO;
    }
...
//    }
    ...
    private String typeHtct;

	public String getTypeHtct() {
		return typeHtct;
	}

	public void setTypeHtct(String typeHtct) {
