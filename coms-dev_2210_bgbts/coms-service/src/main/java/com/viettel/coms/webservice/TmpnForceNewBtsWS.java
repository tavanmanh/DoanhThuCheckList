...
public interface TmpnForceNewBtsWS {
    ...
    public List<TmpnForceNewBtsDTO> getAll() throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    TmpnForceNewBtsDTO getOneById(Long costCenterId) throws Exception;

    @WebMethod(operationName = "save")
    Long save(TmpnForceNewBtsDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(TmpnForceNewBtsDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<TmpnForceNewBtsDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<TmpnForceNewBtsDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
            throws Exception;
