...
@Repository("yearPlanDetailOSDAO")
public class YearPlanDetailOSDAO extends BaseFWDAOImpl<YearPlanDetailOSBO, Long>{
		 public YearPlanDetailOSDAO() {
		        this.model = new YearPlanDetailOSBO();
		 }
	
		 public YearPlanDetailOSDAO(Session session) {
		      this.session = session;
		 }
	 
	    public boolean getSysGroupData(YearPlanDetailOSDTO newObj, String sysGroupCode) {
