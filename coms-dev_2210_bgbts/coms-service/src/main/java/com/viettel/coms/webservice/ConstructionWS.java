...
public interface ConstructionWS {
    ...
    public List<ConstructionDTO> getAll() throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    ConstructionDTO getOneById(Long costCenterId) throws Exception;

    @WebMethod(operationName = "save")
    Long save(ConstructionDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(ConstructionDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<ConstructionDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<ConstructionDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
            throws Exception;
