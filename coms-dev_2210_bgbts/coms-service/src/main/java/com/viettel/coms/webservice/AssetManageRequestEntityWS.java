...
public interface AssetManageRequestEntityWS {
    ...
    public List<AssetManageRequestEntityDTO> getAll() throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    AssetManageRequestEntityDTO getOneById(Long costCenterId) throws Exception;

    @WebMethod(operationName = "save")
    Long save(AssetManageRequestEntityDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(AssetManageRequestEntityDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<AssetManageRequestEntityDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<AssetManageRequestEntityDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
            throws Exception;
