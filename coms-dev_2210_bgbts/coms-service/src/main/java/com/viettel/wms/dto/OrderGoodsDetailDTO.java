...
public class OrderGoodsDetailDTO extends wmsBaseDTO<OrderGoodsDetailBOWMS> {
    ...
    @Override
    public OrderGoodsDetailBOWMS toModel() {
        OrderGoodsDetailBOWMS orderGoodsDetailBO = new OrderGoodsDetailBOWMS();
