...
public class OrderGoodsDTO extends wmsBaseDTO<OrderGoodsBOWMS> implements Cloneable {
    ...
    @Override
    public OrderGoodsBOWMS toModel() {
        OrderGoodsBOWMS orderGoodsBO = new OrderGoodsBOWMS();
