...
import com.viettel.wms.bo.OrderGoodsDetailBOWMS;
...
@Service("orderGoodsDetailBusinessImplWms")
@Scope(proxyMode = ScopedProxyMode.TARGET_CLASS)
public class OrderGoodsDetailBusinessImpl extends BaseFWBusinessImpl<OrderGoodsDetailDAO, OrderGoodsDetailDTO, OrderGoodsDetailBOWMS> implements OrderGoodsDetailBusiness {
    ...
    public OrderGoodsDetailBusinessImpl() {
        tModel = new OrderGoodsDetailBOWMS();
