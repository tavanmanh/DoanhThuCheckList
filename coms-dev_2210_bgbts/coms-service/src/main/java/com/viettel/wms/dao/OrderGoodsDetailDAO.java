 ...
 */
@Repository("orderGoodsDetailDAOWms")
public class OrderGoodsDetailDAO extends BaseFWDAOImpl<OrderGoodsDetailBOWMS, Long> {

    public OrderGoodsDetailDAO() {
        this.model = new OrderGoodsDetailBOWMS();
    }
