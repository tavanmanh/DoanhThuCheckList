...
public abstract class wmsBaseDTO<Entity extends BaseFWModelImpl> extends BaseFWDTOImpl<Entity> {
    ...
    private List<OrderGoodsExelDTO> lstErrorOrder;
    ...
    public List<OrderGoodsExelDTO> getLstErrorOrder() {
        return lstErrorOrder;
    }

    public void setLstErrorOrder(List<OrderGoodsExelDTO> lstErrorOrder) {
        this.lstErrorOrder = lstErrorOrder;
    }
