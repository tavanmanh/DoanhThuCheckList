...
public class DesEncryptPoolDatasource extends AbstractPoolBackedDataSource implements PooledDataSource, Serializable, Referenceable {
    ...
    public DesEncryptPoolDatasource() {
        this(true);
    }

    public DesEncryptPoolDatasource(boolean autoregister) {
        super(autoregister);
    ...
    public DesEncryptPoolDatasource(String configName) {
        this();
...
//        dmds.setJdbcUrl(jdbcUrl);
        dmds.setJdbcUrl(PassTranformer.decrypt(jdbcUrl));
...
//        dmds.setUser(user);
    	dmds.setUser(PassTranformer.decrypt(user));
        this.resetPoolManager(false);
    }
    ...
    public void setPassword(String password) {
        dmds.setPassword(PassTranformer.decrypt(password));
        this.resetPoolManager(false);
    }
...
//      sb.append("; userOverrides: " + userOverrides.toString());
    ...
    public static void main(String [] args) {
    	String conn = PassTranformer.encrypt("jdbc:oracle:thin:@(DESCRIPTION=(LOAD_BALANCE=YES) (ADDRESS= (PROTOCOL=TCP) (HOST= 10.248.242.63) (PORT= 1521)) (ADDRESS= (PROTOCOL=TCP) (HOST= 10.248.242.63) (PORT= 1521)) (CONNECT_DATA= (SERVER=DEDICATED) (SERVICE_NAME= dbaiolab)))");
    	String user = PassTranformer.encrypt("CTCT_COMS_OWNER");
    	String pass = PassTranformer.encrypt("Ctct@2020");
