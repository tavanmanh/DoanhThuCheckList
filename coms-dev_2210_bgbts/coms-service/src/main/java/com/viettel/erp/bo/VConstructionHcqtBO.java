...
public class VConstructionHcqtBO extends BaseFWModelImpl {
	...
	/*
	 * private java.util.Date acceptStartDate; private java.util.Date
	 * acceptFinishDate;
	 */
	...
	public VConstructionHcqtDTO toDTO() {
		...
		vConstructionHcqtDTO.setInvestGroupName(investGroupName);
		vConstructionHcqtDTO.setMonitorGroupName(monitorGroupName);
		vConstructionHcqtDTO.setConsultGroupName(consultGroupName);
		vConstructionHcqtDTO.setProvinceGroupId(provinceGroupId);
		vConstructionHcqtDTO.setSettlementStatusId(settlementStatusId);
		return vConstructionHcqtDTO;
	}

	@Column(name = "INVEST_GROUP_NAME")
	...
	@Column(name = "MONITOR_GROUP_NAME")
	...
	@Column(name = "CONSULT_GROUP_NAME")
