...
public class CategoryAcceptanceModelBO extends BaseFWModelImpl {
    ...
    private CategoryAcceptanceBO categoryAcceptaceBO;

    public CategoryAcceptanceModelBO() {
    ...
    */
    ...
    public CategoryAcceptanceBO getCategoryAcceptaceBO() {
        return categoryAcceptaceBO;
    }

    public void setCategoryAcceptaceBO(CategoryAcceptanceBO categoryAcceptaceBO) {
        this.categoryAcceptaceBO = categoryAcceptaceBO;
    }
