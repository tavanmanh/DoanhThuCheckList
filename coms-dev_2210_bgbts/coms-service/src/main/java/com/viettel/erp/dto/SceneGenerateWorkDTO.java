...
public class SceneGenerateWorkDTO extends BaseFWDTOImpl<SceneGenerateWorkBO> {
    ...
    /**
     * @param bbhtpsklList the bbhtpsklList to set
     */
    ...
    /**
     * @param aDirectorIdName the aDirectorIdName to set
     */
    ...
    /**
     * @param aInChargeMonitorIdName the aInChargeMonitorIdName to set
     */
    ...
    /**
     * @param bDirectorIdName the bDirectorIdName to set
     */
    ...
    /**
     * @param bInChargeConstructIdName the bInChargeConstructIdName to set
     */
    ...
    /**
     * @param cDesignDirectionIdName the cDesignDirectionIdName to set
     */
    ...
    /**
     * @param cDesignManagerIdName the cDesignManagerIdName to set
     */
