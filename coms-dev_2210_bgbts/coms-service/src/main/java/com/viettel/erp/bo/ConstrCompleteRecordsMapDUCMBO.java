 ...
 * @since: 1.0
 */
public class ConstrCompleteRecordsMapDUCMBO extends BaseFWModelImpl {
    ...
    private DistanceUnloadConstrMinutesBO distanceunloadconstrminutes;

    public ConstrCompleteRecordsMapDUCMBO() {
    ...
    public ConstrCompleteRecordsMapDTO toDTO() {
        ...
        constrCompleteRecordsMapDTO.setDataTableIdValue(this.distanceunloadconstrminutes == null ? null : this.distanceunloadconstrminutes.getDisUnloadConsMinId());
