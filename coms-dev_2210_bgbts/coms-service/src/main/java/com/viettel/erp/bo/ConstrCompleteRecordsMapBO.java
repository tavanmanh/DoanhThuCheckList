...
@Entity (name = "constrcompleterecordsmap")
 ...
 * @since: 1.0
 */
public class ConstrCompleteRecordsMapBO extends BaseFWModelImpl {
	...
	@Column(name = "SIGN_USER_ID", length = 22)
	...
	ConstructionAcceptanceBO constructionacceptance;
	DistanceUnloadConstrMinutesBO distanceunloadconstrminutes;

	public ConstrCompleteRecordsMapBO() {
...
/*	@OneToOne(fetch = FetchType.LAZY, optional = true)
	...
	@JoinColumn(name = "DATA_TABLE_ID_VALUE", insertable = false, updatable = false)
	public DistanceUnloadConstrMinutesBO getDistanceunloadconstrminutes() {
		return distanceunloadconstrminutes;
	}

	public void setDistanceunloadconstrminutes(DistanceUnloadConstrMinutesBO distanceunloadconstrminutes) {
		this.distanceunloadconstrminutes = distanceunloadconstrminutes;
	}
	...
	public ConstrCompleteRecordsMapDTO toDTO() {
		...
		constrCompleteRecordsMapDTO.setCode(this.code);
