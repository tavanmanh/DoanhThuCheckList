...
public class VConstructionHcqtDTO extends BaseFWDTOImpl<VConstructionHcqtBO> {
	...
	// HieuNC 09/09/2017
	// Expand 4 field completeRecordNum (số biên bản đã lập) , signedRecordNum
	// (số biên bản đã ký/duyệt)
	// khu vực (provinceGroupId) và tình trạng quyết toán
	// cho chức năng Quản lý bộ HSHC
