...
public class ConstrGroundHandoverDTO extends BaseFWDTOImpl<ConstrGroundHandoverBO> {
	...
	// HieuNC 08/09/2017
	// Bổ sung thêm các trường thông tin Ngày gửi phương án thi công
	// (exclusionPlantSentDate),
	// Ngày khởi công (startExclusionDate), Ngày kết thúc khởi công
	// (endExclusionDate),
	// chủ đầu tư (investGroupName, đơn vị giám sát (monitorGroupName)
	@JsonDeserialize(using = JsonDateDeserializer.class)
	@JsonSerialize(using = JsonDateSerializer.class)
	private Date exclusionPlantSentDate;
	@JsonDeserialize(using = JsonDateDeserializer.class)
	@JsonSerialize(using = JsonDateSerializer.class)
	private Date startExclusionDate;
	@JsonDeserialize(using = JsonDateDeserializer.class)
	@JsonSerialize(using = JsonDateSerializer.class)
	private Date endExclusionDate;
	private String investGroupName;
	private String monitorGroupName;
	private String constructorName;

	private String adirectorNamePosition;
	private String amonitorNamePosition;
	private String ainChargeMonitorNamePosition;
	private String bdirectorNamePosition;
	private String binChargeConstructNamePosition;

	public String getAdirectorNamePosition() {
		return adirectorNamePosition;
	}

	public void setAdirectorNamePosition(String adirectorNamePosition) {
		this.adirectorNamePosition = adirectorNamePosition;
	}

	public String getAmonitorNamePosition() {
		return amonitorNamePosition;
	}

	public void setAmonitorNamePosition(String amonitorNamePosition) {
		this.amonitorNamePosition = amonitorNamePosition;
	}

	public String getAinChargeMonitorNamePosition() {
		return ainChargeMonitorNamePosition;
	}

	public void setAinChargeMonitorNamePosition(String ainChargeMonitorNamePosition) {
		this.ainChargeMonitorNamePosition = ainChargeMonitorNamePosition;
	}

	public String getBdirectorNamePosition() {
		return bdirectorNamePosition;
	}

	public void setBdirectorNamePosition(String bdirectorNamePosition) {
		this.bdirectorNamePosition = bdirectorNamePosition;
	}

	public String getBinChargeConstructNamePosition() {
		return binChargeConstructNamePosition;
	}

	public void setBinChargeConstructNamePosition(String binChargeConstructNamePosition) {
		this.binChargeConstructNamePosition = binChargeConstructNamePosition;
	}

	// format Date to String in format "dd/MM/yyyy" supported XDocReport
	public String getExclusionPlantSentDateString() {
		if (this.exclusionPlantSentDate == null) {
			return "";
		} else
			return UDate.toSimpleFormat(this.exclusionPlantSentDate);
	}

	public String getStartExclusionDateString() {
		if (this.startExclusionDate == null) {
			return "";
		} else
			return UDate.toSimpleFormat(this.startExclusionDate);
	}

	public String getEndExclusionDateString() {
		if (this.endExclusionDate == null) {
			return "";
		} else
			return UDate.toSimpleFormat(this.endExclusionDate);
	}
	// End
	...
	public ConstrGroundHandoverBO toModel() {
		...
		// HieuNC 10/10/2017
		constrGroundHandoverBO.setExclusionPlantSentDate(exclusionPlantSentDate);
		constrGroundHandoverBO.setStartExclusionDate(startExclusionDate);
		constrGroundHandoverBO.setEndExclusionDate(endExclusionDate);
		// End
		...
		constrGroundHandoverBO.setSupervisingConsultant(this.supervisingConsultant);
	...
	public Date getExclusionPlantSentDate() {
		return exclusionPlantSentDate;
	}

	public void setExclusionPlantSentDate(Date exclusionPlantSentDate) {
		this.exclusionPlantSentDate = exclusionPlantSentDate;
	}

	public Date getStartExclusionDate() {
		return startExclusionDate;
	}

	public void setStartExclusionDate(Date startExclusionDate) {
		this.startExclusionDate = startExclusionDate;
	}

	public Date getEndExclusionDate() {
		return endExclusionDate;
	}

	public void setEndExclusionDate(Date endExclusionDate) {
		this.endExclusionDate = endExclusionDate;
	}
	...
	// Huypq-20190729-start
	private String supervisingConsultant;

	public String getSupervisingConsultant() {
		return supervisingConsultant;
	}

	public void setSupervisingConsultant(String supervisingConsultant) {
		this.supervisingConsultant = supervisingConsultant;
	}

	@JsonDeserialize(using = JsonDateDeserializer.class)
	@JsonSerialize(using = JsonDateSerializer.class)
	private Date startExclustionDate;
	@JsonDeserialize(using = JsonDateDeserializer.class)
	@JsonSerialize(using = JsonDateSerializer.class)
	private Date endExclustionDate;

	public Date getStartExclustionDate() {
		return startExclustionDate;
	}

	public void setStartExclustionDate(Date startExclustionDate) {
		this.startExclustionDate = startExclustionDate;
	}

	public Date getEndExclustionDate() {
		return endExclustionDate;
	}

	public void setEndExclustionDate(Date endExclustionDate) {
		this.endExclustionDate = endExclustionDate;
	}

	//HienLT56 add 04092020
	public java.lang.Long getaMonitorId() {
		return aMonitorId;
	}
