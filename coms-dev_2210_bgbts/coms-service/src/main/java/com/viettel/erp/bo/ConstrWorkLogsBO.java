...
public class ConstrWorkLogsBO extends BaseFWModelImpl {
	...
	@Column(name = "CONSTRUCTION_CONDITION")
	...
	public ConstrWorkLogsDTO toDTO() {
		...
		constrWorkLogsDTO.setConstructionCondition(this.constructionCondition);
		constrWorkLogsDTO.setWorkerCount(this.workerCount);
