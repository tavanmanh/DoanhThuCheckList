 ...
 * @author thinhnd
 */
@XmlRootElement(name = "RoleConfigProvinceUserCTCTBO")
@JsonIgnoreProperties(ignoreUnknown = true)
public class RoleConfigProvinceUserCTCTDTO extends BaseFWDTOImpl<BaseFWModelImpl> {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1153401569491550624L;
	private java.lang.Long roleConfigProvinceUserCTCTId;
	...
	public java.lang.Long getRoleConfigProvinceUserCTCTId() {
		return roleConfigProvinceUserCTCTId;
	}

	public void setRoleConfigProvinceUserCTCTId(java.lang.Long roleConfigProvinceUserCTCTId) {
		this.roleConfigProvinceUserCTCTId = roleConfigProvinceUserCTCTId;
	}
