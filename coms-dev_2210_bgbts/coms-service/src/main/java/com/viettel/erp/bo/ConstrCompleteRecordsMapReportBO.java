...
public class ConstrCompleteRecordsMapReportBO extends BaseFWModelImpl {
    ...
    private QualityCableMeaReportBO reportBO;

    public ConstrCompleteRecordsMapReportBO() {
    ...
    public QualityCableMeaReportBO getReportBO() {
        return reportBO;
    }

    public void setReportBO(QualityCableMeaReportBO reportBO) {
