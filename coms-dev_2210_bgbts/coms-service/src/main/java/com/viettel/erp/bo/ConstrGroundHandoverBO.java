...
public class ConstrGroundHandoverBO extends BaseFWModelImpl {
	...
	// HieuNC 08/09/2017
	// Bổ sung trường Ngày gửi phương án thi công, Ngày khởi công, Ngày kết thúc
	// khởi công tương ứng
	// các cột EXCLUSION_PLANT_SENT_DATE, START_EXCLUSION_DATE, END_EXCLUSION_DATE
	...
	@Column(name = "SUPERVISING_CONSULTANT")
	...
	@Column(name = "EXCLUSION_PLANT_SENT_DATE")
	...
	@Column(name = "START_EXCLUSTION_DATE")
	...
	@Column(name = "END_EXCLUSTION_DATE")
	...
	public ConstrGroundHandoverDTO toDTO() {
		...
		// HieuNC 08/09/2017
		// convert to constrGroundHandoverDTO additional field
		constrGroundHandoverDTO.setExclusionPlantSentDate(this.exclusionPlantSentDate);
		constrGroundHandoverDTO.setStartExclusionDate(this.startExclusionDate);
		constrGroundHandoverDTO.setEndExclusionDate(this.endExclusionDate);
		// End
		constrGroundHandoverDTO.setSupervisingConsultant(this.supervisingConsultant);
