...
public class MonitorMissionAssignDTO extends BaseFWDTOImpl<MonitorMissionAssignBO> {
	...
	// HieuNC 07/09/2017
	// Bổ sung thông tin đơn vị giám sát (monitorGroupName), ngày hoàn thành
	// (completeDate),chủ đầu tư (investGroupName)
	...
	public String getCompleteDateString() {
		...
		return UDate.toSimpleFormat(completeDate);
	}

	@JsonSerialize(using = JsonDateSerializer.class)
	@JsonDeserialize(using = JsonDateDeserializer.class)
	private java.util.Date completeDate;
	private java.lang.String monitorPosition;
	private java.lang.String directorPosition;
	...
	public MonitorMissionAssignBO toModel() {
		...
		monitorMissionAssignBO.setCompleteDate(this.completeDate);
	...
	public java.lang.String getMonitorPosition() {
		return monitorPosition;
	}

	public void setMonitorPosition(java.lang.String monitorPosition) {
		this.monitorPosition = monitorPosition;
	}

	public java.lang.String getDirectorPosition() {
		return directorPosition;
	}

	public void setDirectorPosition(java.lang.String directorPosition) {
